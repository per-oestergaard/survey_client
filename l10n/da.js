OC.L10N.register(
    ...
    "An error occurred while sending your report." : "Der skete en fejl, da din rapport skulle sendes",
        "App list <em>(for each app: name, version, enabled status)</em>": "Applisten <em>(For hver app: navn, version, aktiveret eller ej)</em>",
    "Database environment <em>(type, version, database size)</em>" : "Databasemiljø <em>(type, version, database størrelse)</em>",
    "Encryption information <em>(is it enabled?, what is the default module)</em>" : "Krypteringsinformation <em>(er det slået til?, Hvad er standardmodulet)</em>",
    "Number of shares <em>(per type and permission setting)</em>" : "Antal delinger <em>(pr. type og tilladelser)</em>",
    ...
    "Server instance details <em>(version, memcache used, status of locking/previews/avatars)</em>" : "Serverdetaljer <em>(version, memcache brugt, locking/previews/avatars aktiveret?)</em>",
    "Statistic <em>(number of files, users, storages per type, comments and tags)</em>" : "Statistik <em>(antal filer, brugere, lager pr. type, kommentarer og tags)</em>",
    "Usage survey" : "Brugsundersøgelse",
    "Help improve Nextcloud" : "Hjælp med at forbedre Nextcloud",
    "Do you want to help us to improve Nextcloud by providing some anonymized data about your setup and usage? You can disable it at any time in the admin settings again." : "Vil du hjælpe os med at forbedre Nextcloud ved at sende anonyme data om din opsætning og forbrug? Du kan deaktivere det til enhver tid i administratorindstillingerne.",
    ...
    "We take your privacy seriously. Sending data is disabled by default, and should you choose to turn it on, it will be anonymized first, and you are given the option of what things to share. Upon receiving a report, the previous one is removed. To delete the stored usage data, upload an empty report by unchecking all of the boxes then sending a new report." : "Vi tager dit privatliv seriøst. Afsendelse af data er som standard deaktiveret. Vælger du at aktivere det, så vil data først blive anonymiseret, og du får mulighed for at vælge, hvilke ting du vil dele. Når vi modtager en rapport, slettes den tidligere modtagne. For at slette de delte anvendelsesdata, send blot en tom rapport ved at fjerne markeringen i alle bokse, og indsend så en ny rapport.",
